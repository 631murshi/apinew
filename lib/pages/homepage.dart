...
import 'package:mysecondproject/Model/modelclass.dart';
...
class _homepageState extends State<homepage> {
  ...
  List<Productlist>? productlist;
   ...
   Future<ModelClass> firstapi() async
   {
...
proimage=obj_modelclass!.profileImage;
name=obj_modelclass!.name;
card=obj_modelclass!.card;

for(int i=0;i<obj_modelclass!.dashlist!.length;i++)
  {
dashlist!.add(obj_modelclass!.dashlist![i]);
  }
for(int i=0;i<obj_modelclass!.productlist!.length;i++)
  {
    productlist!.add(obj_modelclass!.productlist![i]);
  }
      }
    ...
    return Scaffold(
        body: FutureBuilder(
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                return homewidget(
                  proimage, name, card, dashlist, productlist,
                );
              }
              else {
                            ...
                            children: [
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment
                                        .start,
                                    children: [
                                      Text(dashlist![0].catName.toString()),
                                      Text(
                                        dashlist![0].amount.toString(),
                                        style: TextStyle(
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [Text(dashlist![0].date.toString())],
                                ),
                              )
                            ],
                          ),
                            ...
                            child: Row(
                              children: [
                                  ...
                                  child: Container(
                                      ...
                                      child: Column(
                                        crossAxisAlignment: CrossAxisAlignment
                                            .start,
                                        children: [
                                          Text(dashlist![1].catName.toString()),
                                          Text(
                                            dashlist![1].amount.toString(),
                                            style:
                                            TextStyle(
                                                fontWeight: FontWeight.bold),
                                          ),
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.end,
                                    children: [Text(dashlist![1].date.toString())],
                                  ),
                                )
                              ],
                            ),
                            ...
                            child: Row(
                              children: [
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment
                                          .start,
                                      children: [
                                        Text(dashlist![2].catName.toString()),
                                        Text(
                                          dashlist![2].amount.toString(),
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold),
                                        ),
                                      ],
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.end,
                                    children: [Text(dashlist![2].date.toString())],
                                  ),
                                )
                              ],
                            ),
